...
import { stats, history, values, team, clients } from '../data/aboutData'
...
const Section = ({ children, className = '' }) => (
  ...
  >
    <div className="w-full lg:w-[65%] mx-auto px-6">{children}</div>
  </motion.section>
)
  ...
  return (
    <div className="bg-white font-sans text-slate-800">
      ...
      <Section className="bg-slate-50">
        ...
        <motion.p
          className="text-justify md:text-center text-sm text-slate-600 leading-relaxed my-4 md:w-[65%] mx-auto"
          variants={itemVariants}
        >
